...
-- Hash bcrypt de "Test123" con salt rounds 10
INSERT INTO users (username, first_name, last_name, email, password, balance) VALUES
('testuser', 'Test', 'User', 'test@casino.com', '$2b$10$YourHashedPasswordHere', 1000.00),
('admin', 'Admin', 'Casino', 'admin@casino.com', '$2b$10$YourHashedPasswordHere', 10000.00);

-- Actualizar role del admin
...
-- PERMISOS
-- ================================================
-- Crear rol para la aplicación (recomendado para producción)
-- CREATE ROLE casino_app WITH LOGIN PASSWORD 'strong_password_here';
-- GRANT CONNECT ON DATABASE casino_royal_db TO casino_app;
